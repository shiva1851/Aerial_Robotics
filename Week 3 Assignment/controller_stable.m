function [u1, u2] = controller(~, state, des_state, params)
    ...
    k_pphi = 1000;  % Proportional gain for roll control
    k_dphi = 1000;  % Derivative gain for roll control
    
    k_py = 35;    % Proportional gain for lateral control
    k_dy = 35;    % Derivative gain for lateral control
